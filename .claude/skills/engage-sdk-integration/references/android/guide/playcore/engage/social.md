...
**_Recommendation_** clusters show personalized suggestions from an individual
developer partner.
...
| Title                                            | **Required** | The title for the Recommendation Cluster (for example, _Latest from your friends_). **Recommended text size: under 25 chars** (Text that is too long may show ellipses)                                                                                 |
