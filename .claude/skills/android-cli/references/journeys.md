...
not crash or behave in an unexpected manner. This is the _only_ verification you should perform for an `<action>`.
...
if the _current_ Android app can correctly handle the _current_ steps outlined in the journey. Suggestions for bug fixes, clarification, or
