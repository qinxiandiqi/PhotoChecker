...
distributed. You can think of this as the item's _preferred_ size.
...
have been added up. The `grow` value indicates _how much_ of the extra space a
...
except that, instead of distributing _extra space_ to items, the _space deficit_
